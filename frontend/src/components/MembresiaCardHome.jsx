  ...
  return (
    <div
      className={`rounded-2xl p-8 shadow-lg flex flex-col justify-between ${
        destacado ? "bg-gray-900 text-white" : "bg-white text-black"
      }`}
    >
      {destacado && (
        <div className="bg-accent text-accent-foreground text-sm font-bold px-3 py-1 rounded-full w-fit mb-4">
          Más beneficios
        </div>
      )}
      ...
      <div>
        ...
        <button className="bg-accent text-accent-foreground font-semibold py-2 rounded-full w-full mb-6 hover:bg-gray-400 transition">
          ¡Inscribite ya!
        </button>
